...
#endif
#ifdef _WIN32
inline constexpr float MOVE_AND_STRAFE_SPEED = 1000; /// TODO: @sckorn figure out, why the difference is so drastic
#endif
            ...
            {rcbe::core::InputEventType::key_press,
             [rendering_context = ctx, &c](
                 ...
                 InputManagerImplementation::PreviousEventReference previous) {
                    RDMN_LOG(RDMN_LOG_DEBUG) << "Delta time " << rendering_context->computeDeltaTime();
