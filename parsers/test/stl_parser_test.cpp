...
TEST(ParsersTest, TestSTLParse) {
    ...
    const std::string file_path = "../+http_file+low_poly_wolf_stl/file/LowPolyWolf.stl";
    _impl(file_path, TOTAL_TRIANGLES);
}

TEST(ParsersTest, BeardedYell_15k_Solid) {
    static constexpr size_t TOTAL_TRIANGLES = 30526;
    const std::string file_path = "../+http_archive+stl_test_data_archive/BeardedYell_15k_Solid.stl";
    _impl(file_path, TOTAL_TRIANGLES);
}

TEST(ParsersTest, BeardedYell_30k_Solid) {
    static constexpr size_t TOTAL_TRIANGLES = 60520;
    const std::string file_path = "../+http_archive+stl_test_data_archive/BeardedYell_30k_Solid.stl";
    _impl(file_path, TOTAL_TRIANGLES);
}

TEST(ParsersTest, BeardedYell_Low_137k_Solid) {
    static constexpr size_t TOTAL_TRIANGLES = 134026;
    const std::string file_path = "../+http_archive+stl_test_data_archive/BeardedYell_Low_137k_Solid.stl";
    _impl(file_path, TOTAL_TRIANGLES);
}

TEST(ParsersTest, BeardedYell_Mid_372k_Solid) {
    static constexpr size_t TOTAL_TRIANGLES = 361762;
    const std::string file_path = "../+http_archive+stl_test_data_archive/BeardedYell_Mid_372k_Solid.stl";
    _impl(file_path, TOTAL_TRIANGLES);
}
...
TEST(ParsersTest, BeardedYell_High_965k_Solid) {
    ...
    const std::string file_path = "../+http_archive+stl_test_data_archive/BeardedYell_High_965k_Solid.stl";
    _impl(file_path, TOTAL_TRIANGLES);
}

TEST(ParsersTest, BeardedYell_Highest_2804k_Solid) {
    static constexpr size_t TOTAL_TRIANGLES = 2719830;
    const std::string file_path = "../+http_archive+stl_test_data_archive/BeardedYell_Highest_2804k_Solid.stl";
    _impl(file_path, TOTAL_TRIANGLES);
}