...
namespace nlohmann {
template <>
struct R_PUBLIC_API adl_serializer<gltf_pbr_met_rough> {
...
template <>
struct R_PUBLIC_API adl_serializer<gltf_material> {
...
template <>
struct R_PUBLIC_API adl_serializer<gltf_texture> {
...
template <>
struct R_PUBLIC_API adl_serializer<gltf_image> {
...
template <>
struct R_PUBLIC_API adl_serializer<gltf_buffer> {
...
template <>
struct R_PUBLIC_API adl_serializer<gltf_buffer_view> {
...
template <>
struct R_PUBLIC_API adl_serializer<gltf_accessor> {
...
template <>
struct R_PUBLIC_API adl_serializer<gltf_mesh_attr> {
...
template <>
struct R_PUBLIC_API adl_serializer<gltf_mesh_prim> {
...
template <>
struct R_PUBLIC_API adl_serializer<gltf_mesh> {
...
template <>
struct R_PUBLIC_API adl_serializer<gltf_node> {
