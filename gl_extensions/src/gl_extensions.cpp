...
private:
    const std::unordered_map<GLenum, std::string> gl_errors_ = {
            ...
            {GL_INVALID_VALUE, "A value parameter is not a legal value for that function."},
            ...
            {GL_OUT_OF_MEMORY, "An operation that can allocate memory, and the memory cannot be allocated."},
...
:
impl_ { std::make_unique<GLErrorProcImpl>() }
{}
...
///////////////////////////////////////////////////////////////////////////////
GLExtensions& GLExtensions::getInstance()
{
    static GLExtensions self;
    self.getExtensionStrings();
    return self;
}
...
///////////////////////////////////////////////////////////////////////////////
bool GLExtensions::isSupported(const std::string& ext)
{
...
///////////////////////////////////////////////////////////////////////////////
const std::vector<std::string>& GLExtensions::getExtensions()
{
...
///////////////////////////////////////////////////////////////////////////////
void GLExtensions::getExtensionStrings()
{
    const char* cstr = (const char*)glGetString(GL_EXTENSIONS);

    if (cstr == NULL)
        throw std::runtime_error("Error when retreiving gl extensions string");
...
// string utility
///////////////////////////////////////////////////////////////////////////////
std::string GLExtensions::toLower(const std::string& str)
{
...
///////////////////////////////////////////////////////////////////////////////
void GLExtensions::getFunctionPointers()
{
#ifdef _WIN32
    std::vector<std::string>::const_iterator iter = this->extensions.begin();
    std::vector<std::string>::const_iterator endIter = this->extensions.end();
    ...
    for(int i = 0; i < (int)extensions.size(); ++i)
    {
        ...
        {
            glActiveTexture = (PFNGLACTIVETEXTUREPROC)glXGetProcAddress(reinterpret_cast<const GLubyte *>("glActiveTexture"));
            /*
        ...
        else if(extensions[i] == "GL_ARB_vertex_buffer_object") // same as PBO
        {
            ...
            glBufferSubDataARB          = (PFNGLBUFFERSUBDATAARBPROC)glXGetProcAddress("glBufferSubDataARB");
            glDeleteBuffersARB          = (PFNGLDELETEBUFFERSARBPROC)glXGetProcAddress("glDeleteBuffersARB");
            glGetBufferParameterivARB   = (PFNGLGETBUFFERPARAMETERIVARBPROC)glXGetProcAddress("glGetBufferParameterivARB");
            glMapBufferARB              = (PFNGLMAPBUFFERARBPROC)glXGetProcAddress("glMapBufferARB");
            glUnmapBufferARB            = (PFNGLUNMAPBUFFERARBPROC)glXGetProcAddress("glUnmapBufferARB");
            */
        }
        else if(extensions[i] == "GL_ARB_shader_objects")
        {
            ...
            glUniform1iv            = (PFNGLUNIFORM1FVPROC)glXGetProcAddress(reinterpret_cast<const GLubyte *>("glUniform1iv"));
            glUniform2iv            = (PFNGLUNIFORM2FVPROC)glXGetProcAddress(reinterpret_cast<const GLubyte *>("glUniform2iv"));
            glUniform3iv            = (PFNGLUNIFORM3FVPROC)glXGetProcAddress(reinterpret_cast<const GLubyte *>("glUniform3iv"));
            glUniform4iv            = (PFNGLUNIFORM4FVPROC)glXGetProcAddress(reinterpret_cast<const GLubyte *>("glUniform4iv"));
            ...
            /*
            glDeleteObjectARB           = (PFNGLDELETEOBJECTARBPROC)glXGetProcAddress("glDeleteObjectARB");
            glGetHandleARB              = (PFNGLGETHANDLEARBPROC)glXGetProcAddress("glGetHandleARB");
            glDetachObjectARB           = (PFNGLDETACHOBJECTARBPROC)glXGetProcAddress("glDetachObjectARB");
            ...
            glValidateProgramARB        = (PFNGLVALIDATEPROGRAMARBPROC)glXGetProcAddress("glValidateProgramARB");
            glUniform1fARB              = (PFNGLUNIFORM1FARBPROC)glXGetProcAddress("glUniform1fARB");
            glUniform2fARB              = (PFNGLUNIFORM2FARBPROC)glXGetProcAddress("glUniform2fARB");
            glUniform3fARB              = (PFNGLUNIFORM3FARBPROC)glXGetProcAddress("glUniform3fARB");
            glUniform4fARB              = (PFNGLUNIFORM4FARBPROC)glXGetProcAddress("glUniform4fARB");
            glUniform1iARB              = (PFNGLUNIFORM1IARBPROC)glXGetProcAddress("glUniform1iARB");
            glUniform2iARB              = (PFNGLUNIFORM2IARBPROC)glXGetProcAddress("glUniform2iARB");
            glUniform3iARB              = (PFNGLUNIFORM3IARBPROC)glXGetProcAddress("glUniform3iARB");
            glUniform4iARB              = (PFNGLUNIFORM4IARBPROC)glXGetProcAddress("glUniform4iARB");
            glUniform1fvARB             = (PFNGLUNIFORM1FVARBPROC)glXGetProcAddress("glUniform1fvARB");
            glUniform2fvARB             = (PFNGLUNIFORM2FVARBPROC)glXGetProcAddress("glUniform2fvARB");
            glUniform3fvARB             = (PFNGLUNIFORM3FVARBPROC)glXGetProcAddress("glUniform3fvARB");
            glUniform4fvARB             = (PFNGLUNIFORM4FVARBPROC)glXGetProcAddress("glUniform4fvARB");
            glUniform1ivARB             = (PFNGLUNIFORM1FVARBPROC)glXGetProcAddress("glUniform1ivARB");
            glUniform2ivARB             = (PFNGLUNIFORM2FVARBPROC)glXGetProcAddress("glUniform2ivARB");
            glUniform3ivARB             = (PFNGLUNIFORM3FVARBPROC)glXGetProcAddress("glUniform3ivARB");
            glUniform4ivARB             = (PFNGLUNIFORM4FVARBPROC)glXGetProcAddress("glUniform4ivARB");
            glUniformMatrix2fvARB       = (PFNGLUNIFORMMATRIX2FVARBPROC)glXGetProcAddress("glUniformMatrix2fvARB");
            glUniformMatrix3fvARB       = (PFNGLUNIFORMMATRIX3FVARBPROC)glXGetProcAddress("glUniformMatrix3fvARB");
            glUniformMatrix4fvARB       = (PFNGLUNIFORMMATRIX4FVARBPROC)glXGetProcAddress("glUniformMatrix4fvARB");
            glGetObjectParameterfvARB   = (PFNGLGETOBJECTPARAMETERFVARBPROC)glXGetProcAddress("glGetObjectParameterfvARB");
            ...
            glGetAttachedObjectsARB     = (PFNGLGETATTACHEDOBJECTSARBPROC)glXGetProcAddress("glGetAttachedObjectsARB");
            glGetUniformLocationARB     = (PFNGLGETUNIFORMLOCATIONARBPROC)glXGetProcAddress("glGetUniformLocationARB");
            glGetActiveUniformARB       = (PFNGLGETACTIVEUNIFORMARBPROC)glXGetProcAddress("glGetActiveUniformARB");
            glGetUniformfvARB           = (PFNGLGETUNIFORMFVARBPROC)glXGetProcAddress("glGetUniformfvARB");
            glGetUniformivARB           = (PFNGLGETUNIFORMIVARBPROC)glXGetProcAddress("glGetUniformivARB");
            glGetShaderSourceARB        = (PFNGLGETSHADERSOURCEARBPROC)glXGetProcAddress("glGetShaderSourceARB");
            */
        }
        else if(extensions[i] == "GL_ARB_sync")
        {
        ...
        else if(extensions[i] == "GL_ARB_vertex_shader") // also GL_ARB_fragment_shader
        {
            ...
            /*
            glBindAttribLocationARB = (PFNGLBINDATTRIBLOCATIONARBPROC)glXGetProcAddress("glBindAttribLocationARB");
            glGetActiveAttribARB    = (PFNGLGETACTIVEATTRIBARBPROC)glXGetProcAddress("glGetActiveAttribARB");
            glGetAttribLocationARB  = (PFNGLGETATTRIBLOCATIONARBPROC)glXGetProcAddress("glGetAttribLocationARB");
            */
        }
        else if(extensions[i] == "GL_ARB_vertex_program") // also GL_ARB_fragment_program
        {
            ...
            /*
            glVertexAttrib1dARB             = (PFNGLVERTEXATTRIB1DARBPROC)glXGetProcAddress("glVertexAttrib1dARB");
            glVertexAttrib1dvARB            = (PFNGLVERTEXATTRIB1DVARBPROC)glXGetProcAddress("glVertexAttrib1dvARB");
            glVertexAttrib1fARB             = (PFNGLVERTEXATTRIB1FARBPROC)glXGetProcAddress("glVertexAttrib1fARB");
            glVertexAttrib1fvARB            = (PFNGLVERTEXATTRIB1FVARBPROC)glXGetProcAddress("glVertexAttrib1fvARB");
            glVertexAttrib1sARB             = (PFNGLVERTEXATTRIB1SARBPROC)glXGetProcAddress("glVertexAttrib1sARB");
            glVertexAttrib1svARB            = (PFNGLVERTEXATTRIB1SVARBPROC)glXGetProcAddress("glVertexAttrib1svARB");
            glVertexAttrib2dARB             = (PFNGLVERTEXATTRIB2DARBPROC)glXGetProcAddress("glVertexAttrib2dARB");
            glVertexAttrib2dvARB            = (PFNGLVERTEXATTRIB2DVARBPROC)glXGetProcAddress("glVertexAttrib2dvARB");
            glVertexAttrib2fARB             = (PFNGLVERTEXATTRIB2FARBPROC)glXGetProcAddress("glVertexAttrib2fARB");
            glVertexAttrib2fvARB            = (PFNGLVERTEXATTRIB2FVARBPROC)glXGetProcAddress("glVertexAttrib2fvARB");
            glVertexAttrib2sARB             = (PFNGLVERTEXATTRIB2SARBPROC)glXGetProcAddress("glVertexAttrib2sARB");
            glVertexAttrib2svARB            = (PFNGLVERTEXATTRIB2SVARBPROC)glXGetProcAddress("glVertexAttrib2svARB");
            glVertexAttrib3dARB             = (PFNGLVERTEXATTRIB3DARBPROC)glXGetProcAddress("glVertexAttrib3dARB");
            glVertexAttrib3dvARB            = (PFNGLVERTEXATTRIB3DVARBPROC)glXGetProcAddress("glVertexAttrib3dvARB");
            glVertexAttrib3fARB             = (PFNGLVERTEXATTRIB3FARBPROC)glXGetProcAddress("glVertexAttrib3fARB");
            glVertexAttrib3fvARB            = (PFNGLVERTEXATTRIB3FVARBPROC)glXGetProcAddress("glVertexAttrib3fvARB");
            glVertexAttrib3sARB             = (PFNGLVERTEXATTRIB3SARBPROC)glXGetProcAddress("glVertexAttrib3sARB");
            glVertexAttrib3svARB            = (PFNGLVERTEXATTRIB3SVARBPROC)glXGetProcAddress("glVertexAttrib3svARB");
            glVertexAttrib4NbvARB           = (PFNGLVERTEXATTRIB4NBVARBPROC)glXGetProcAddress("glVertexAttrib4NbvARB");
            glVertexAttrib4NivARB           = (PFNGLVERTEXATTRIB4NIVARBPROC)glXGetProcAddress("glVertexAttrib4NivARB");
            glVertexAttrib4NsvARB           = (PFNGLVERTEXATTRIB4NSVARBPROC)glXGetProcAddress("glVertexAttrib4NsvARB");
            glVertexAttrib4NubARB           = (PFNGLVERTEXATTRIB4NUBARBPROC)glXGetProcAddress("glVertexAttrib4NubARB");
            glVertexAttrib4NubvARB          = (PFNGLVERTEXATTRIB4NUBVARBPROC)glXGetProcAddress("glVertexAttrib4NubvARB");
            glVertexAttrib4NuivARB          = (PFNGLVERTEXATTRIB4NUIVARBPROC)glXGetProcAddress("glVertexAttrib4NuivARB");
            glVertexAttrib4NusvARB          = (PFNGLVERTEXATTRIB4NUSVARBPROC)glXGetProcAddress("glVertexAttrib4NusvARB");
            glVertexAttrib4bvARB            = (PFNGLVERTEXATTRIB4BVARBPROC)glXGetProcAddress("glVertexAttrib4bvARB");
            glVertexAttrib4dARB             = (PFNGLVERTEXATTRIB4DARBPROC)glXGetProcAddress("glVertexAttrib4dARB");
            glVertexAttrib4dvARB            = (PFNGLVERTEXATTRIB4DVARBPROC)glXGetProcAddress("glVertexAttrib4dvARB");
            glVertexAttrib4fARB             = (PFNGLVERTEXATTRIB4FARBPROC)glXGetProcAddress("glVertexAttrib4fARB");
            glVertexAttrib4fvARB            = (PFNGLVERTEXATTRIB4FVARBPROC)glXGetProcAddress("glVertexAttrib4fvARB");
            glVertexAttrib4ivARB            = (PFNGLVERTEXATTRIB4IVARBPROC)glXGetProcAddress("glVertexAttrib4ivARB");
            glVertexAttrib4sARB             = (PFNGLVERTEXATTRIB4SARBPROC)glXGetProcAddress("glVertexAttrib4sARB");
            glVertexAttrib4svARB            = (PFNGLVERTEXATTRIB4SVARBPROC)glXGetProcAddress("glVertexAttrib4svARB");
            glVertexAttrib4ubvARB           = (PFNGLVERTEXATTRIB4UBVARBPROC)glXGetProcAddress("glVertexAttrib4ubvARB");
            glVertexAttrib4uivARB           = (PFNGLVERTEXATTRIB4UIVARBPROC)glXGetProcAddress("glVertexAttrib4uivARB");
            glVertexAttrib4usvARB           = (PFNGLVERTEXATTRIB4USVARBPROC)glXGetProcAddress("glVertexAttrib4usvARB");
            glVertexAttribPointerARB        = (PFNGLVERTEXATTRIBPOINTERARBPROC)glXGetProcAddress("glVertexAttribPointerARB");
            glEnableVertexAttribArrayARB    = (PFNGLENABLEVERTEXATTRIBARRAYARBPROC)glXGetProcAddress("glEnableVertexAttribArrayARB");
            glDisableVertexAttribArrayARB   = (PFNGLDISABLEVERTEXATTRIBARRAYARBPROC)glXGetProcAddress("glDisableVertexAttribArrayARB");
            glProgramStringARB              = (PFNGLPROGRAMSTRINGARBPROC)glXGetProcAddress("glProgramStringARB");
            glBindProgramARB                = (PFNGLBINDPROGRAMARBPROC)glXGetProcAddress("glBindProgramARB");
            glDeleteProgramsARB             = (PFNGLDELETEPROGRAMSARBPROC)glXGetProcAddress("glDeleteProgramsARB");
            glGenProgramsARB                = (PFNGLGENPROGRAMSARBPROC)glXGetProcAddress("glGenProgramsARB");
            glProgramEnvParameter4dARB      = (PFNGLPROGRAMENVPARAMETER4DARBPROC)glXGetProcAddress("glProgramEnvParameter4dARB");
            glProgramEnvParameter4dvARB     = (PFNGLPROGRAMENVPARAMETER4DVARBPROC)glXGetProcAddress("glProgramEnvParameter4dvARB");
            glProgramEnvParameter4fARB      = (PFNGLPROGRAMENVPARAMETER4FARBPROC)glXGetProcAddress("glProgramEnvParameter4fARB");
            glProgramEnvParameter4fvARB     = (PFNGLPROGRAMENVPARAMETER4FVARBPROC)glXGetProcAddress("glProgramEnvParameter4fvARB");
            glProgramLocalParameter4dARB    = (PFNGLPROGRAMLOCALPARAMETER4DARBPROC)glXGetProcAddress("glProgramLocalParameter4dARB");
            glProgramLocalParameter4dvARB   = (PFNGLPROGRAMLOCALPARAMETER4DVARBPROC)glXGetProcAddress("glProgramLocalParameter4dvARB");
            glProgramLocalParameter4fARB    = (PFNGLPROGRAMLOCALPARAMETER4FARBPROC)glXGetProcAddress("glProgramLocalParameter4fARB");
            glProgramLocalParameter4fvARB   = (PFNGLPROGRAMLOCALPARAMETER4FVARBPROC)glXGetProcAddress("glProgramLocalParameter4fvARB");
            glGetProgramEnvParameterdvARB   = (PFNGLGETPROGRAMENVPARAMETERDVARBPROC)glXGetProcAddress("glGetProgramEnvParameterdvARB");
            glGetProgramEnvParameterfvARB   = (PFNGLGETPROGRAMENVPARAMETERFVARBPROC)glXGetProcAddress("glGetProgramEnvParameterfvARB");
            glGetProgramLocalParameterdvARB = (PFNGLGETPROGRAMLOCALPARAMETERDVARBPROC)glXGetProcAddress("glGetProgramLocalParameterdvARB");
            glGetProgramLocalParameterfvARB = (PFNGLGETPROGRAMLOCALPARAMETERFVARBPROC)glXGetProcAddress("glGetProgramLocalParameterfvARB");
            glGetProgramivARB               = (PFNGLGETPROGRAMIVARBPROC)glXGetProcAddress("glGetProgramivARB");
            glGetProgramStringARB           = (PFNGLGETPROGRAMSTRINGARBPROC)glXGetProcAddress("glGetProgramStringARB");
            glGetVertexAttribdvARB          = (PFNGLGETVERTEXATTRIBDVARBPROC)glXGetProcAddress("glGetVertexAttribdvARB");
            glGetVertexAttribfvARB          = (PFNGLGETVERTEXATTRIBFVARBPROC)glXGetProcAddress("glGetVertexAttribfvARB");
            glGetVertexAttribivARB          = (PFNGLGETVERTEXATTRIBIVARBPROC)glXGetProcAddress("glGetVertexAttribivARB");
            glGetVertexAttribPointervARB    = (PFNGLGETVERTEXATTRIBPOINTERVARBPROC)glXGetProcAddress("glGetVertexAttribPointervARB");
            glIsProgramARB                  = (PFNGLISPROGRAMARBPROC)glXGetProcAddress("glIsProgramARB");
            */
        }
        else if(extensions[i] == "GL_ARB_debug_output")
        {
            ...
            /*
            glDebugMessageControlARB  = (PFNGLDEBUGMESSAGECONTROLARBPROC)glXGetProcAddress("glDebugMessageControlARB");
            glDebugMessageInsertARB   = (PFNGLDEBUGMESSAGEINSERTARBPROC)glXGetProcAddress("glDebugMessageInsertARB");
            glDebugMessageCallbackARB = (PFNGLDEBUGMESSAGECALLBACKARBPROC)glXGetProcAddress("glDebugMessageCallbackARB");
            glGetDebugMessageLogARB   = (PFNGLGETDEBUGMESSAGELOGARBPROC)glXGetProcAddress("glGetDebugMessageLogARB");
            */
        }
        else if(extensions[i] == "GL_ARB_direct_state_access")
        {
            ...
            glGetTransformFeedbackiv                   = (PFNGLGETTRANSFORMFEEDBACKIVPROC)glXGetProcAddress(reinterpret_cast<const GLubyte *>("pglGetTransformFeedbackiv"));
            glGetTransformFeedbacki_v                  = (PFNGLGETTRANSFORMFEEDBACKI_VPROC)glXGetProcAddress(reinterpret_cast<const GLubyte *>("pglGetTransformFeedbacki_v"));
            glGetTransformFeedbacki64_v                = (PFNGLGETTRANSFORMFEEDBACKI64_VPROC)glXGetProcAddress(reinterpret_cast<const GLubyte *>("pglGetTransformFeedbacki64_v"));
            // for buffer object
            ...
            glGetQueryBufferObjectiv                   = (PFNGLGETQUERYBUFFEROBJECTIVPROC)glXGetProcAddress(reinterpret_cast<const GLubyte *>("glGetQueryBufferObjectiv"));
            glGetQueryBufferObjectuiv                  = (PFNGLGETQUERYBUFFEROBJECTUIVPROC)glXGetProcAddress(reinterpret_cast<const GLubyte *>("glGetQueryBufferObjectuiv"));
            glGetQueryBufferObjecti64v                 = (PFNGLGETQUERYBUFFEROBJECTI64VPROC)glXGetProcAddress(reinterpret_cast<const GLubyte *>("glGetQueryBufferObjecti64v"));
            glGetQueryBufferObjectui64v                = (PFNGLGETQUERYBUFFEROBJECTUI64VPROC)glXGetProcAddress(reinterpret_cast<const GLubyte *>("glGetQueryBufferObjectui64v"));
        }
    }
#endif
#endif
